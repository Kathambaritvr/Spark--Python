# -*- coding: utf-8 -*-
"""
Created on Wed Feb 26 12:31:25 2020
...
autoMap = parts.map(lambda p: Row(make=p[0],\
        body=p[4], hp=int(p[7])))
#Infer the schema, and registar the DataFrame as a table
...
#registar a data fraame as table and run SQL statements against it
